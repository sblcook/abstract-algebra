...
\begin{homeworkProblem}[1]
	...
	\begin{solution}\\
	We know that there are 4 roots, since it is a degree 4 polynomial. By Lemma 4.29, we know that $1+2i$ is also a root. Then 
	\[(x-(1-2i))(x-(1+2i)) = (x^2 -2x+5) \mid  (x^4-3x^3 +x^2+7x-30)\]
	since $1-2i$ and $1+2i$ are roots. When we do the division, we get that 
	\[x^4-3x^3 +x^2+7x-30 = (x^2 -2x+5)(x^2-x-6)\] 
	It is easy to see that $x^2-x-6$ factors into $(x-3)(x+2)$. Therefore, the roots of the polynomial are $3, -2, 1+2i, 1-2i$.
