...
$\Leftarrow$ This proof is simply the above proof in reverse. Assume that $a_0 + ... + a_n = 0_F$ in $\mathbb{F}[x]$. This can be rewritten as $a_01 + ... + a_n1 = 0_F$, or $a_01^0 + ... + a_n1^n = 0_F$. This is the form of a polynomial root evaluated at 1, so we can rewrite this as $a_nx^n + ... + a_2x^2 +a_1x+a_0$
\end{homeworkProblem}
